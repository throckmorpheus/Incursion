...
public class CustomEnchantingTableBlockEntityRenderer implements BlockEntityRenderer<CustomEnchantingTableBlockEntity> {
    ...
    public void render(CustomEnchantingTableBlockEntity enchantingTableBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        matrixStack.push();
